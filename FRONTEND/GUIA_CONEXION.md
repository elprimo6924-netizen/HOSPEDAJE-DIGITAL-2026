...
- Configuración de la URL del backend: `http://localhost:3306/api`
...
El backend iniciará en `http://localhost:3306`
...
Abre en tu navegador: `http://localhost:3306`
...
- Habitaciones: `http://localhost:3306/api/habitaciones`
- Clientes: `http://localhost:3306/api/clientes`
- Reservas: `http://localhost:3306/api/reservas`
- Servicios: `http://localhost:3306/api/servicios`

### 3. Verificar estructura de tablas
`http://localhost:3306/api/debug/estructura`
...
1. Verifica que el backend esté corriendo en puerto 3306
