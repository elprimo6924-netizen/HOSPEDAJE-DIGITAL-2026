...
// Imágenes de habitaciones de hotel para usar como fallback diferenciado
const HABITACION_PLACEHOLDERS = [
    'https://images.unsplash.com/photo-1631049307264-da0ec9d70304?w=400&q=75',
    'https://images.unsplash.com/photo-1618773928121-c32242e63f39?w=400&q=75',
    'https://images.unsplash.com/photo-1566073771259-6a8506099945?w=400&q=75',
    'https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?w=400&q=75',
    ...
    'https://images.unsplash.com/photo-1455587734955-081b22074882?w=400&q=75',
    'https://images.unsplash.com/photo-1512918728675-ed5a9ecdebfd?w=400&q=75',
...
const mostrarMensajeClienteAdmin = (mensaje, tipo = 'info') => {
    if (tipo === 'ok' || tipo === 'error') {
        if (typeof showAlert === 'function')
            showAlert(mensaje, tipo === 'ok' ? 'success' : 'error');
    }
};
...
const renderizarHabitacionesAdmin = () => {
    ...
    contenedor.innerHTML = habitacionesVisibles.map((habitacion, idx) => {
        const idHabitacion = obtenerIdHabitacion(habitacion);
        const estado = normalizarEstadoHabitacion(habitacion.Estado);
        const placeholder = HABITACION_PLACEHOLDERS[idx % HABITACION_PLACEHOLDERS.length];
        const rawImg = obtenerImagenPrincipalHabitacion(habitacion);
        const imagenUrl = (rawImg && rawImg !== 'assets/images/default.svg') ? rawImg : placeholder;
            ...
            <tr>
                <td>
                    <div class="crud-habitaciones-imagen">
                        <img src="${imagenUrl}" alt="${escaparHtml(habitacion.NombreHabitacion || 'Habitación')}" onerror="this.src='${placeholder}'">
                    </div>
                </td>
                <td>
